...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: CreateProfilePageWidget.routeName,
          path: CreateProfilePageWidget.routePath,
          requireAuth: true,
        ...
        FFRoute(
          name: ProfileViewPageWidget.routeName,
          path: ProfileViewPageWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ProfileViewPageWidget(
